...
**/
    ...
    public String getRegistrationPage(ModelMap uiModel){
    	Vehicle car=registration.getNewCar();
    	System.out.println(car+"CAr in registration");
    	uiModel.addAttribute("car1", car);
        return "carregister";
    }
  ...
  */
    @RequestMapping("/done")
    public String getResponsePage(@ModelAttribute(value = "car2") Car car){
